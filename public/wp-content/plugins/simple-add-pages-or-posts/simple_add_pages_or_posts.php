...
class plugin_simple_add_pages_or_posts extends mijnpress_plugin_framework
{
	 ...
	 */
	function addPluginContent($links, $file, $strictstandardvoid1 = '', $strictstandardvoid2 = '') {
		$plugin = new plugin_simple_add_pages_or_posts();
...
{
	add_action('admin_menu',  array('plugin_simple_add_pages_or_posts', 'addPluginSubMenu'));
	add_filter('plugin_row_meta',array('plugin_simple_add_pages_or_posts', 'addPluginContent'), 10, 2);
}
?>
