<?php
	...
	function create_post_types() {
		...
		//Team
		create_post_type( 'Team', 'Team', 'dashicons-groups', array('title','editor','excerpt','thumbnail') );

		//Team
		create_post_type('Case study', 'Case studies', 'dashicons-star-empty', array('title','editor','excerpt','thumbnail'));
